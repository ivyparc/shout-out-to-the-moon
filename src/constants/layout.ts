...
export const DB_RANGES = [
  { id: "20-40", min: 20, max: 40, label: "20\n40" },
  { id: "40-60", min: 40, max: 60, label: "40\n60" },
  { id: "60-80", min: 60, max: 80, label: "60\n80" },
  { id: "80-100", min: 80, max: 100, label: "80\n100" },
  { id: "100+", min: 100, max: 111, label: "100\n+" },
] as const;
